...
contract AaveHelpers is DSMath {
    ...
    */
    function getAaveAddressProvider() internal pure returns (address) {
        return 0xAcc030EF66f9dFEAE9CbB0cd1B25654b82cFA8d5; // Mainnet
    ...
    */
    function getAaveProtocolDataProvider() internal pure returns (address) {
        return 0xc443AD9DDE3cecfB9dfC5736578f447aFE3590ba; // Mainnet
...
contract InstaAaveV2AMMResolver is Resolver {
    string public constant name = "AaveV2-AMM-Resolver-v1";
}
